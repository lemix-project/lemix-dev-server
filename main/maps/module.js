module.exports = {
    ...
    "GET_LIST":
        "SELECT P1.ns_identifier, P2.ns_name, P1.mm_identifier, P1.mm_name, P1.bundle_identifier, P1.mm_description, P1.create_time,count(P1.mm_identifier) over () total FROM mix_module P1 LEFT JOIN name_space P2 ON P1.ns_identifier = P2.ns_identifier WHERE P1.ns_identifier = ? LIMIT ?,?",
    "POST":
